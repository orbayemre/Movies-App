export default function GoToTop(){
    ...
    return(
            ...
            <div id="gototop" onClick={topFunction} className="cursor-pointer disableSelect fixed flex justify-center items-center duration-1000 -bottom-48 right-10 w-10 h-10 z-50 inline-block bg-background shadowType1 text-baseColor rounded scroll-smooth">

                    ...
                    if(imgUrl){
                        return(
                            <SwiperSlide className="w-56 h-60 disableSelect ">
                                <div key={index} className="w-56 h-60 mx-0 opacity-100 my-3 cursor-context-menu rounded-lg relative shadowType1 cursor-pointer bg-baseColor ">
                                    <img src={imgUrl} className="w-full h-full rounded-lg"/>
                                    <div className="w-full space-y-0 absolute flex flex-col bottom-0 z-10 bg-black/60 pb-1 pl-2 font-Signika ">
